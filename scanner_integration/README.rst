.. image:: static/description/banner.png
   :alt: Direct Document Scanner — Odoo 17
   :width: 100%

===========================================
Direct Document Scanner for Odoo 17 CE
===========================================
...
🦉 Native OWL 2 Widget
  Drop-in integration for Odoo 17 forms. No configuration needed.
...
2. Download the scanner bridge binary for your platform from the
   `Releases Page <https://github.com/alzarough1106/odoo17-binaries/releases>`_.
